...
describe('Blockchain', () => {
    ...
    describe('isValidChain()', () => {
        ...
        describe('when the chain starts with the genesis block and has multiple blocks', () => {
            ...
            describe('and the chain contains a block an invalid field', () => {
                it('returns false', () => {
    ...
    describe('validTransactionData()', () => {
        ...
        beforeEach(() => {
            wallet = new Wallet();
            transaction = wallet.createTransaction({ recipient: 'wild-address', amount: 25 });
